package com.javierjulio.flexlib.containers
{
	...
	/**
	 * The GradientHBox inherits everything from its superclass HBox but adds 
	 * new style properties.
	 * 
	 * @mxml
	 * 
	 * <p>The <code>&lt;containers:GradientHBox&gt;</code> tag inherits all of the tag 
	 * attributes of its superclass and adds the following tag attributes:</p>
	 *  
	 * <pre>
	 * &lt;containers:GradientHBox
	 ...
	 * </pre>
	 * 
	 * @see com.javierjulio.flexlib.containers.GradientCanvas
	...
	public class GradientHBox extends HBox 
	{
		 ...
		 */
		private static const LOGGER:ILogger = Log.getLogger("com.javierjulio.flexlib.containers.GradientHBox");
		...
		{
			if (!StyleManager.getStyleDeclaration("GradientHBox"))
			{
				// if there is no CSS definition for GradientHBox we set our default values
				...
				StyleManager.setStyleDeclaration("GradientHBox", styles, false);
			}
			return true;
		}
