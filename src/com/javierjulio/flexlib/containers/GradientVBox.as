package com.javierjulio.flexlib.containers
{
	...
	/**
	 * The GradientVBox inherits everything from its superclass VBox but adds 
	 * new style properties.
	 * 
	 * @mxml
	 * 
	 * <p>The <code>&lt;containers:GradientVBox&gt;</code> tag inherits all of the tag 
	...
	public class GradientVBox extends VBox 
	{
		 ...
		 */
		private static const LOGGER:ILogger = Log.getLogger("com.javierjulio.flexlib.containers.GradientVBox");
		...
		private static function constructClass():Boolean 
		{
			...
			{
				// if there is no CSS definition for GradientVBox we set our default values
				...
				StyleManager.setStyleDeclaration("GradientVBox", styles, false);
			}
			return true;
		}
